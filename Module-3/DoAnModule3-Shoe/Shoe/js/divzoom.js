...
//     //	var indexThumb = $(this).index.html();
...
//     });
//     if($(window).width() > 768){
//       var ncurrent = parseInt($(".gallery-index.html .current").html()) - 1;
//     }
//     else{
//       var ncurrent = parseInt($(".product-gallery-item.is-selected").index.html());
//     }
